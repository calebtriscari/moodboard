...
newweek = {'Week':datetoday,'Mean':round(df1.Sentiment.mean(), 4),'Median':round(df1.Sentiment.median(), 4),
           'SD':round(df1.Sentiment.std(),4), 'MaxSentiment':round(df1.Sentiment.max(),4), 'MaxSong':df1['Song'][maxindex],
           'MaxArtist':df1['Artist'][maxindex], 'MinSentiment':round(df1.Sentiment.min(), 4), 'MinSong':df1['Song'][minindex],
...
newentries = df1[df1['Lyrics'] != 'None']
